                ...
                <div class="title m-b-md text-primary">
                    <div >
                        <select required id="sel">
                          <option value=""
                                  hidden 
                          >Choose an animal to adopt</option>
                        ...
                        <script>
                            ...
                            var afficheValeur = document.getElementById("myDiv");
                
                            optionSelection.addEventListener("change", function() {
                            var le_text = optionSelection.options[optionSelection.selectedIndex];
                            afficheValeur.innerHTML = le_text.text;
